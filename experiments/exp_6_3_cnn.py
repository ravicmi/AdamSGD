...
Compare Adam, SGD+Momentum, AdaGrad, and RMSProp on CNN.
"""
...
def run_experiment_6_3(config_path='config/config.yaml'):
    """
    Run Experiment 6.3: Convolutional Neural Network on CIFAR-10.
    
    Args:
        config_path (str): Path to configuration file
    """
    print("=" * 80)
    print("EXPERIMENT 6.3: Convolutional Neural Network on CIFAR-10")
    print("=" * 80)
    ...
    num_epochs = config[mode]['epochs']['cnn']
    ...
    optimizers_to_test = config['experiments']['exp_6_3']['optimizers']
    ...
    for optimizer_name in optimizers_to_test:
        ...
        model = CNN(
            ...
            fc_hidden=config['models']['cnn']['fc_hidden'],
    ...
    plot_multiple_comparisons(
        ...
        save_dir='results/exp_6_3_cnn',
        config=config,
        experiment_name='Exp 6.3: CNN on CIFAR-10'
    )
    
    # Print summary
    print("\n" + "=" * 80)
    print("EXPERIMENT 6.3 SUMMARY")
    print("=" * 80)
    ...
    print(f"Results saved to: results/exp_6_3_cnn/")
