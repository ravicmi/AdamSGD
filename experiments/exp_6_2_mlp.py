...
Compare Adam, SGD+Momentum, AdaGrad, and RMSProp on multi-layer neural network.
"""
...
def run_experiment_6_2(config_path='config/config.yaml'):
    """
    Run Experiment 6.2: Multi-Layer Perceptron on MNIST.
    
    Args:
        config_path (str): Path to configuration file
    """
    print("=" * 80)
    print("EXPERIMENT 6.2: Multi-Layer Perceptron on MNIST")
    print("=" * 80)
    ...
    num_epochs = config[mode]['epochs']['mlp']
    ...
    optimizers_to_test = config['experiments']['exp_6_2']['optimizers']
    ...
    plot_multiple_comparisons(
        ...
        save_dir='results/exp_6_2_mlp',
        config=config,
        experiment_name='Exp 6.2: Multi-Layer Perceptron on MNIST'
    )
    
    # Print summary
    print("\n" + "=" * 80)
    print("EXPERIMENT 6.2 SUMMARY")
    print("=" * 80)
    ...
    print(f"Results saved to: results/exp_6_2_mlp/")
